...
from ibm_watsonx_orchestrate.agent_builder.tools import PythonTool, OpenAPITool, OpenAPIRuntimeServerBinding
...
async def main():
    ...
    langgraph_get_facts_tool = as_langchain_tool(get_cat_fact)
    langgraph_openapi_cat_facts_tool = as_langchain_tool(openapi_cat_facts_tool)
