...
from ibm_watsonx_orchestrate.agent_builder.agents.types import DEFAULT_LLM, AgentManagementStyle
from unittest.mock import patch

def test_agent_import_call_no_file():
    with patch("ibm_watsonx_orchestrate.cli.commands.agents.agents_command.agents_controller.import_agent") as mock:
...
def test_agent_create_call_expert_agent():
    with patch("ibm_watsonx_orchestrate.cli.commands.agents.agents_command.agents_controller.create_agent") as mock:
